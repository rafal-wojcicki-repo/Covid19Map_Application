...
Please download all code onto your computer and run SpringbootMapInitApplication.class using Inteliij Idea Ultimate.
After startup the app tries to open your default browser on:
- localhost:8080/map - map view rendered with Thymeleaf

You can also open these endpoints manually:
- localhost:8080 - business endpoint returning COVID points in JSON
